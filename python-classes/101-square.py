...
class Square:
    ...
    This class maintains a private size attribute and a positional tuple offset.
    It supports area calculations, explicit layout printing, and direct string 
    typecasting behavior equivalent to its printing method.
    """
    ...
    def __init__(self, size=0, position=(0, 0)):
        ...
        Args:
            ...
            position (tuple): A tuple containing exactly two positive integers
                representing horizontal and vertical printing offsets.
                Defaults to (0, 0).
        """
        self.size = size
